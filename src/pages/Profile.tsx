...
import { User, Moon, Sun, Globe, ChevronRight, LogOut, Camera, Shield } from 'lucide-react';
  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-4 pb-20">
      ...
      <div className="flex flex-col items-center py-6">
        ...
        <Badge variant="secondary" className="mt-1 text-[10px] capitalize">{userRole}</Badge>
      </div>
