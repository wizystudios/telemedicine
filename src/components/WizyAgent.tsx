...
import { Bot, Mic, MicOff, Send, X, Sparkles, Loader2, Stethoscope, Building2, Pill, TestTube, MapPin, Star, Phone, Calendar as CalIcon, ShoppingCart, ArrowRight, UserCheck, UserX, Clock, CheckCircle2, AlertCircle, ShieldCheck } from 'lucide-react';
