...
import { AlertCircle, Camera, FileText, Mic, Video, Send, Image } from 'lucide-react';
...
export function PatientProblemPost() {
  ...
  const selectedUrgency = urgencyLevels.find(level => level.id === urgencyLevel);
